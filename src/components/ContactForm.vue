        ...
        <div class="shadow-[0_5px_25px_-3px_rgba(0,0,0,0.1)] rounded-xl p-12 grid md:flex gap-8 bg-white">
          ...
          <form @submit.prevent="submit" class="grid md:grid-cols-2 gap-4 grow" novalidate="true">
            ...
            <div class="grid md:col-span-2 ">
              ...
              <textarea class="px-2 py-1 border-2 rounded-lg border-blue-600 transition duration-200 outline outline-transparent outline-offset-1 outline-2 focus:outline-blue-600 h-32" name="message" id="message" v-model="message"></textarea>
            </div>
            <input type="submit" value="Envoyer" class="md:col-span-2 ml-auto cursor-pointer px-5 py-2 bg-blue-600 shadow-md shadow-blue-600/50 hover:shadow-blue-600/25 transition duration-200 text-white rounded-xl flex items-center w-fit">
          </form>
        </div>
      </div>
    </section>
